...
#--- sway 설치
pacman -Sy --noconfirm sway noto-fonts noto-fonts-cjk noto-fonts-emoji wayland wayland-protocols xdg-desktop-portal-wlr gtk3 gtk4 qt6-wayland qt6-svg mbedtls ffmpegthumbnailer gst-libav gst-plugins-good gst-plugin-va xfce4-terminal pavucontrol grim slurp swaybg swayidle swaylock waybar dmenu wofi xorg-xwayland thunar tumbler gvfs polkit-gnome pango cairo gdk-pixbuf2 pcre2 swayidle swaylock python-i3ipc
